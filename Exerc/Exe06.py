...
# Em seguida, invoque os parâmetros da segunda função de x e y. Some x e y e retorne o resultado.
# Em func1(), ao receber o resultado, retorne-o também como valor de retorno da função.
